...
def generate_cert(name, track):
    ...
    #now the image
    template = cv2.imread('cert_template.jpeg')           #Loading the img
    ...
    font2 = ImageFont.truetype('NotoSans-Italic.ttf', 35)  
    ...
    if type(name) == list:
        ...
        draw.text((h, w+60), name.upper(), font=font1, fill='#646464') 
...
cv2.imwrite('new/cert_m.jpeg', template)